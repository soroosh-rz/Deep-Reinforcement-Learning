...
- `dqn_agent.py`: Create an Agent class that interacts with the environment and learns from it 
- `model.py`: Q-network class used to map state to action values 
- `saved_models`: A folder containing files weights corresponding to different hyperparameters  
